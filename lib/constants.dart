...
const Duration shakeDebounceDuration = Duration(milliseconds: 500); // Prevent multi-counts per shake
const String prefsKeyAlarms = 'alarms_list'; // SharedPreferences key for alarms
const String prefsKeyShakeCountPrefix = 'alarm_shake_count_'; // Prefix for storing shake count
...
const int foregroundServiceNotificationId = 889; // Unique ID for foreground notification

const String prefsKeyBatteryOptimizationDismissed = 'battery_optimization_warning_dismissed_v1'; // Add a version marker
const String prefsKeyOverlayPermissionDismissed = 'overlay_permission_warning_dismissed_v1'; // New key
